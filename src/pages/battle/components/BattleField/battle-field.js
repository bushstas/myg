    ...
    componentDidMount() {
        ...
        Object.keys(characters).forEach(id => {
            if (images.indexOf(characters[id].img) === -1) {
                const img = new Image();
                img.src = `/assets/images/creatures/${characters[id].type}/${characters[id].img}_d.png`;
                if (characters[id].leader) {
                    img.src = `/assets/images/creatures/${characters[id].type}/${characters[id].img}_rh.png`;
                }
            }
        });
    }
